...
async function chatbotAsk(req, res) {
  try {
    ...
    // ✅ Check if the user seems to be wrapping up the conversation
    if (accountModel.detectClosingIntent(message)) {
      return res.json({
        type: "confirm_close",
