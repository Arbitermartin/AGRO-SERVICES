...
async function sendAppointmentConfirmation(toEmail, data) {
...
Please arrive/contact us at the scheduled time.

Thank you.`;

  console.log("=====================================");
  console.log("APPOINTMENT EMAIL WOULD BE SENT TO:", toEmail);
  console.log(message);
  console.log("=====================================");

  return { sent: false, subject, message };

  /* Once Gmail SMTP is connected:
  await transporter.sendMail({
    from: `"AgroServices" <${process.env.GMAIL_USER}>`,
    to: toEmail,
    subject,
